...
namespace ContentReupload.YouTube
{
    public class YouTubeUploader
    {
        private readonly string ApplicationName = "YouTube uploader";
        ...
        public async Task<List<SearchResult>> GetVideosAsync(string youtubeChannel)
        {
            ...
            YouTubeService youtubeService = await GetYouTubeServiceAsync(youtubeChannel);
        ...
        private async Task<YouTubeService> GetYouTubeServiceAsync(string youtubeChannel)
        {
            if (youtubeChannel == null)
                throw new ArgumentNullException();
